  ...
  try {
    ...
    const unboxingPresetBlock = isUnboxing
      ? `\nUNBOXING CREATIVE BRIEF — DO STEPS 1–4 SILENTLY, OUTPUT ONLY THE FINAL STRUCTURED SCRIPT.\n` +
        ...
        `  LANE B — CREATOR-AT-HOME UGC (fashion drops, gym/equipment used-not-opened, beauty haul, tech accessory, multi-piece sets, anything dialogue-led). Examples: messy bedroom window UGC with the parcel on an unmade duvet; bathroom vanity with towel/sink/practical bulb for beauty; couch + coffee table + throw blanket + remote; closet floor with shoeboxes for fashion; iPhone front camera + modern gym + tired breath for equipment; car-seat street-drop. Real lived-in details mandatory: wrinkled sheet, half-open drawer, charger cable, coffee mug, mail, laundry chair.\n` +
        ...
        `IMPORTANT — match the product's personality. Collectibles, jewelry, quiet-luxury small goods, ceramics, fragrances, stationery → LANE A (TOP-DOWN ASMR, THEATRICAL REVEAL, MACRO TACTILE, OVERHEAD STILL-LIFE). Fashion drops, multi-piece sets, sneaker drops, streetwear, lingerie haul → LANE B high-energy (HAUL TRY-ON, SCARCITY DROP, FULL-SET REVEAL, BEDROOM WINDOW UGC). Used-not-opened gear (gym bike, blender, camera) → LANE B vlog (VLOG SELFIE / STREET DOC). Beauty/skincare/fragrance → either LANE A (THEATRICAL REVEAL on a vanity) or LANE B (BATHROOM VANITY UGC) depending on packaging energy. NEVER force haul-energy onto a quiet collectible. NEVER force "messy bedroom" onto a designer toy or theatrical jewelry box.\n` +
