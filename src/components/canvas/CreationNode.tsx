...
export function CreationNode({ data }: { data: SpaceNodeData }) {
  return (
    <div className="space-node w-[220px] rounded-xl bg-node border border-node-border shadow-[0_4px_24px_rgba(0,0,0,0.6)]">
