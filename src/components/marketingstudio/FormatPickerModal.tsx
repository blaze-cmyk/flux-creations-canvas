...
export function FormatPickerModal({ open, onOpenChange, selected, onSelect }: Props) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className="p-0 border-0 bg-transparent shadow-none max-w-[1180px] w-[calc(100vw-2rem)] max-h-[92vh] overflow-hidden z-[100] [&>button.absolute.right-4.top-4]:hidden"
